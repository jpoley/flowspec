...
**Approach**: Add backlog CLI calls only at command entry/exit in `.claude/commands/flow/*.md`
...
**Entry Hook Pattern** (add to `.claude/commands/flow/*.md`):
...
- **Command Files**: `.claude/commands/flow/*.md`
...
**Before Integration** (`.claude/commands/flow/specify.md`):

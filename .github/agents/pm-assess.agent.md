...
- Consider whether you need `/pm:define` or another workflow command instead
...
/pm:assess {feature} --mode full

# Force spec-light mode
/pm:assess {feature} --mode light

# Force skip SDD
/pm:assess {feature} --mode skip
```

---

*Assessment generated by /pm:assess workflow*
```

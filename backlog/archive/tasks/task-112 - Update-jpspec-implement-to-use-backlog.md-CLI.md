---
id: task-112
title: 'Update /flowspec:implement to use backlog.md CLI'
status: Done
assignee:
  - '@claude-opus'
...
- [x] #8 Test: Run /flowspec:implement with test task and verify AC progression
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
CRITICAL P0: Updated /flowspec:implement command with full backlog.md CLI integration.
...
- Added tests in tests/test_flowspec_implement_backlog.py (21 tests, all passing)
<!-- SECTION:NOTES:END -->

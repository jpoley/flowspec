...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Backup current .claude/commands/flowspec/ files (git commit before deletion)
- [x] #2 Delete all .claude/commands/flowspec/*.md files
...
<!-- SECTION:NOTES:BEGIN -->
Replaced all command files with symlinks to templates subdirectories. flowspec: 8 commands, speckit: 8 commands
<!-- SECTION:NOTES:END -->

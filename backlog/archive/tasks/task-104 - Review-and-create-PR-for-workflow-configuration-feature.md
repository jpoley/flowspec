...
- [x] #2 PR title: 'feat: workflow configuration system for /flowspec commands'
...
- [x] #9 No breaking changes to existing /flowspec command interfaces
...
PR #239 created: https://github.com/jpoley/flowspec/pull/239

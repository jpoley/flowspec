...
- [x] AC2: Update /flowspec:plan to output ADRs to ./docs/adr/ADR-{NNN}-{slug}.md
...
<!-- SECTION:NOTES:BEGIN -->
## Summary
Implement Architecture Decision Records (ADRs) as required output artifacts from /flowspec:plan with configurable transition validation.

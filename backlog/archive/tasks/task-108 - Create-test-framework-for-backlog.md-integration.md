...
Set up pytest-based test framework to verify flowspec commands correctly use backlog.md CLI. Tests should verify task creation, status updates, AC checking, and proper workflow completion.
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Create tests/test_flowspec_backlog_integration.py test module
...
- [x] #8 All tests pass: pytest tests/test_flowspec_backlog_integration.py
<!-- AC:END -->

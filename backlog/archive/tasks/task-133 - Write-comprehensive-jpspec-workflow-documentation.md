...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Document includes executive summary explaining the purpose and value of the /flowspec workflow system
- [x] #2 Each of the 6 /flowspec commands has a dedicated section with: purpose, when to use, agents invoked, execution pattern, inputs/outputs

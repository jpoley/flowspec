...
- [x] #2 Command Reference (docs/reference/flowspec-security-commands.md)
...
**File**: `docs/reference/flowspec-security-commands.md`
...
Sections:
1. What /flowspec:security protects against

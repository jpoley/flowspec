...
Add '/flowspec:assess' command to evaluate if SDD workflow is appropriate for a feature. Addresses Böckeler critique: 'What I found missing is an answer to: Which problems are they meant for?' Prevents over-specification frustration. Output: Full SDD workflow (complex), Spec-light mode (medium), Skip SDD (simple).
...
- [x] #3 Create /flowspec:assess command in .claude/commands/flowspec/
...
<!-- SECTION:NOTES:BEGIN -->
Implemented comprehensive /flowspec:assess command with:

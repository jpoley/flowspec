---
id: task-096
title: Update /flowspec commands to check workflow constraints
status: Done
assignee: []
...
Update all /flowspec command implementations to enforce workflow state constraints from configuration
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 All /flowspec command implementations updated to load WorkflowConfig
...
- [x] #7 No breaking changes to existing /flowspec command interfaces
...
- Updated all 7 /flowspec commands with workflow validation

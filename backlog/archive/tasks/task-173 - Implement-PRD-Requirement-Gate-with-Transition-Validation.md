...
- [x] AC2: Update /flowspec:specify to output PRD to ./docs/prd/{feature}.md
...
- [x] AC8: Update flowspec_workflow.yml with prd output artifact definition
<!-- AC:END -->
...
<!-- SECTION:NOTES:BEGIN -->
## Summary
Implement PRD (Product Requirements Document) as a required output artifact from /flowspec:specify with configurable transition validation.

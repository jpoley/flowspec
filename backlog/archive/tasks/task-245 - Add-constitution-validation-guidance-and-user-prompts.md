...
- [x] #4 Warn user if they try to use /flowspec commands with unvalidated constitution
...
- AC #4: flowspec commands include `_constitution-check.md` which warns on unvalidated constitutions with tier-based enforcement (light=warn, medium=confirm, heavy=block)

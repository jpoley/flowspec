...
- [x] #3 /flowspec:implement command includes checkpoint reminder for risky changes
...
- Integration with SDD workflow (/flowspec:implement reminder)

Included via @import in CLAUDE.md
Checkpoint reminder added to templates/commands/flowspec/implement.md
<!-- SECTION:NOTES:END -->

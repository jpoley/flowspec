...
- [ ] #2 Determine configuration storage location (flowspec_workflow.yml + .vscode/settings.json)
...
- [ ] #7 Selected role stored in flowspec_workflow.yml
- [ ] #8 Non-interactive mode via --role flag
- [ ] #9 FLOWSPEC_PRIMARY_ROLE env var override works
...
3. Store selection in flowspec_workflow.yml roles.primary field
4. Support --role flag for non-interactive mode
5. Support FLOWSPEC_PRIMARY_ROLE env var override

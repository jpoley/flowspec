...
Document architecture decision for how users select their primary role during /jpspec:init or /jpspec:reset, and how that affects command auto-loading in VS Code
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Define role selection mechanism (interactive prompt during init/reset)
- [x] #2 Document storage location and format (jpspec_workflow.yml or separate file)
...
### 1. Storage Location
Chose jpspec_workflow.yml extension over separate file or global config:
...
Extended jpspec_workflow.yml with role_config section:
```yaml
role_config:
  primary_role: "dev"

...
### Overview
Implement .jpspec/security-config.yml configuration file support for scanner selection, rulesets, path exclusions, and AI settings.
...
class SecurityConfig(BaseModel):
    ...
    # Custom rules
    custom_rules_dir: Optional[str] = ".jpspec/security-rules/"
```
...
```python
def load_security_config(path: str = ".jpspec/security-config.yml") -> SecurityConfig:

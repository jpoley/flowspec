...
Create a structured INITIAL-style document template that becomes the first step before assessing or specifying work. This template captures problem/outcome, examples, documentation links, and gotchas in a standard format.

Source: docs/research/archon-inspired.md Task 1

...
This guide explains the SARIF (Static Analysis Results Interchange Format) output format used by `/jpspec:security` commands for GitHub Code Scanning integration.

...
TAGLINE = f"(v{__version__}) SpecFlow - Spec-Driven Development Toolkit"
...
def upgrade(
    ...
    Examples:
        ...
        specify upgrade --tools      # Same as 'specflow upgrade-tools'
        specify upgrade --repo       # Same as 'specflow upgrade-repo'

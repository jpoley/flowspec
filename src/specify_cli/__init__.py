...
def upgrade_tools(
    component: str = typer.Option(
        ...
        "--component",
        "-c",
        help="Specific component to upgrade (flowspec, spec-kit, backlog). Upgrades all if not specified.",
    ),
    dry_run: bool = typer.Option(
        False, "--dry-run", help="Show what would be upgraded without making changes"
    ),
    ...
    Examples:
        ...
        specify upgrade-tools -c flowspec    # Upgrade only flowspec
    ...
    if version and component and component != "flowspec":
        console.print(
            "[red]Error:[/red] --version only applies to flowspec component"
        )
        raise typer.Exit(1)
...
def dev_setup(
    ...
    console.print(
        "[cyan]Setting up development environment for flowspec...[/cyan]\n"
    )
...
def constitution_diff(
    ...
    # __file__ is at: flowspec/src/specify_cli/__init__.py

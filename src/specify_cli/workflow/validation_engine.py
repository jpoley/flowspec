...
class TransitionValidator:
    ...
    def validate(
        ...
        Returns:
            ValidationResult indicating whether transition is allowed.
    ...
    def _check_artifacts_exist(
        ...
        Returns:
            ValidationResult indicating whether all artifacts exist.
        """
        ...
        for artifact in artifacts:
            ...
            if artifact.multiple:
                ...
                pattern = full_path.name if "*" in full_path.name else full_path.suffix and f"*{full_path.suffix}" or full_path.name
    ...
    def _validate_none(self, transition: TransitionSchema) -> ValidationResult:
        ...
        Returns:
            ValidationResult that always passes.
        """
    ...
    def _validate_keyword(
        ...
        Returns:
            ValidationResult indicating whether keyword was entered correctly.
        """
    ...
    def _prompt_keyword(
        ...
        Returns:
            ValidationResult based on user input.
        """
        print(f"\n{'=' * 60}")
    ...
    def _validate_pull_request(
        ...
        Returns:
            ValidationResult indicating whether a merged PR exists.
        """
        feature = context.get("feature", "")
        if not feature:
    ...
    def _check_pr_merged(
        ...
        Returns:
            ValidationResult indicating whether PR is merged.
        """

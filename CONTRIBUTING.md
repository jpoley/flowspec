...
- Update documentation (`README.md`, `docs/spec-driven.md`) if your changes affect user-facing features.
...
1. Test changes with the `flowspec` CLI commands (`/flow:specify`, `/flow:plan`, `/flow:implement`) in your coding agent of choice
...
For detailed workflows, troubleshooting, and advanced scenarios, see [Dev-Setup Consistency Guide](build-docs/reference/dev-setup-consistency.md).
...
For complete details, see [Dev-Setup Consistency Guide](build-docs/reference/dev-setup-consistency.md).

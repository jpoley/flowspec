...
Complete, production-ready CI/CD configurations for integrating `/flow:security` commands into your development workflow.
        ...
        with:
          script: |
            ...
            **Findings Summary:**
            ...
            ---
            *Generated by [Flowspec](https://github.com/jpoley/jp-spec-kit) Security Scanner*
            `;
...
# Check if Flowspec is installed
if ! command -v specify &> /dev/null; then
    echo "⚠️  Flowspec not found, skipping security scan"
    exit 0
fi

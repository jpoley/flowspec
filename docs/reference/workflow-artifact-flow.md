...
- **3 terminal transitions to 'Done'** (manual completion from various states)
- **3 backward transitions** (2 rework transitions and 1 rollback transition for handling failures)
```
[To Do]
   |
   | (1) /jpspec:specify

...
This guide explains the **single-source-of-truth architecture** for command files in Flowspec, ensuring consistency between development and distribution. The dev-setup system eliminates content divergence by establishing `templates/commands/` as the canonical source for all command files.
...
- **Namespaces**: Subdirectories (`flowspec/`, `speckit/`)
...
vim .claude/commands/flow/implement.md
...
vim templates/commands/flowspec/new-command.md
...
# Should show: new-command.md -> ../../../templates/commands/flowspec/new-command.md

# Test command in Claude Code
# Use: /flow:new-command
```

**Step 4: Commit**
```bash
git add templates/commands/flowspec/new-command.md
git add .claude/commands/flow/new-command.md  # The symlink
git commit -s -m "feat: add new-command for flowspec"
git push origin feature-branch
```
...
git rm templates/commands/flowspec/old-command.md
```

**Step 2: Remove Symlink**
```bash
# Delete the symlink
git rm .claude/commands/flow/old-command.md
```
...
git mv templates/commands/flowspec/old-name.md \
       templates/commands/flowspec/new-name.md
```
...
```bash
# Check new symlink
ls -la .claude/commands/flow/new-name.md
...
**Step 4: Commit**
```bash
git add .claude/commands/flow/new-name.md
...
cp .claude/commands/flow/implement.md /tmp/implement-backup.md

# Run fix
make dev-fix

# Merge changes into template
diff /tmp/implement-backup.md templates/commands/flowspec/implement.md
vim templates/commands/flowspec/implement.md
...
```bash
# Restore from git
git checkout main -- templates/commands/flowspec/implement.md
...
# ✓ Created symlink: .claude/commands/flow/research.md
# ...
# ✓ Dev-setup complete
```
...
Broken symlinks:
  .claude/commands/flow/implement.md -> ../../../templates/commands/flowspec/implement.md
```
...
ls -la templates/commands/flowspec/new-command.md
...
ls -la .claude/commands/flow/implement.md
...
- [ ] **Structure Consistency**
  - [ ] Commands organized in subdirectories (`flowspec/`, `speckit/`)
  - [ ] No flat files with dots (`flowspec.implement.md` is invalid)
  - [ ] Shared partials use underscore prefix (`_backlog-instructions.md`)

- [ ] **Content Quality**
  - [ ] Commands are comprehensive (10-20KB), not minimal stubs (2-3KB)
  - [ ] flowspec commands integrate backlog management
...
- Non-symlink `.md` files in `.claude/commands/`
- Broken symlinks
- Flat file structure (`flowspec.implement.md`)
...
drwxr-xr-x 11 user  staff  352 Dec  3 12:00 flowspec
drwxr-xr-x 10 user  staff  320 Dec  3 12:00 speckit

=== flowspec commands ===
lrwxr-xr-x  1 user  staff  51 Dec  3 12:00 implement.md -> ../../../templates/commands/flowspec/implement.md
...
...
.claude/commands/flow/old-command.md
```
...
tests/test_command_structure.py::test_dev_setup_creates_flowspec_symlinks PASSED
...
Creating symlinks for flowspec commands...
✓ Created symlink: .claude/commands/flow/implement.md
✓ Created symlink: .claude/commands/flow/research.md
...
...
- **Namespace**: Command grouping (flowspec, speckit)

"""Tests for interactive validation mode prompts in specflow init (AC1-4, AC8).

These tests verify:
- AC1: Add validation mode prompts to specflow init command
...
class TestInitInteractivePrompts:
    """Tests for interactive prompts during specflow init."""

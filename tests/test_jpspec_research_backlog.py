"""Integration tests for /jpspec:research command with backlog.md CLI.

This test module verifies that the research command correctly integrates with
backlog.md CLI for research and validation task management.
"""

...
In any slash command (e.g., `.claude/commands/flow/operate.md`):
...
For workflows requiring multiple agents (e.g., `.claude/commands/flow/plan.md`):
...
1. **Update remaining slash commands** to use agent loader:
   ...
   **`.claude/commands/flow/research.md`**:
   ```markdown
...
| `.claude/commands/flow/operate.md` | Operate workflow | ✅ Updated |
| `.claude/commands/flow/specify.md` | Specify workflow | ⏸️ Ready to update |
| `.claude/commands/flow/plan.md` | Plan workflow | ⏸️ Ready to update |
| `.claude/commands/flow/research.md` | Research workflow | ⏸️ Ready to update |
| `.claude/commands/flow/implement.md` | Implement workflow | ⏸️ Ready to update |
| `.claude/commands/flow/validate.md` | Validate workflow | ⏸️ Ready to update |
